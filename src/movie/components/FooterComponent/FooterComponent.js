      ...
      <div className="FooterContentsContainer">
        <div className="iconContainer">
          <svg
            ...
            class="svg-icon svg-icon-facebook-logo ltr-0 e1mhci4z1"
            data-name="Facebook"
            aria-hidden="true"
          >
            <path
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            class="svg-icon svg-icon-instagram-logo ltr-0 e1mhci4z1"
            data-name="Instagram"
            aria-hidden="true"
          >
            <path
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            class="svg-icon svg-icon-twitter-logo ltr-0 e1mhci4z1"
            data-name="Twitter"
            aria-hidden="true"
          >
            <path
          ...
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            class="svg-icon svg-icon-youtube-logo ltr-0 e1mhci4z1"
            data-name="Youtube"
            aria-hidden="true"
          >
            <path
        ...
        <div className="linkContainer">
          <ul className="linkCollection">
            <li className="eachLink">
              <a href="https://www.google.com/" className="eachLinkText">
                화면 해설
              </a>
            </li>
            <li className="eachLink">
        ...
        <div className="serviceCodeContainer">
          <span className="serviceCodeText">서비스 코드</span>
        </div>
